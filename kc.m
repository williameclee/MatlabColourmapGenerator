...
%
%   Syntax:
%   colour = kc(colourname) returns the colour specified by the colour name 
%       or the colour-darkness abbreviation.
%   colour = kc(colourname, darkness) returns the colour with the specified 
%       darkness value.
%   colour = kc(colourname, 'Format', format) returns the colour with the 
%       specified format, 'normalised' or '8bit'.
